...
urlpatterns = [
    ...
    path('events/<int:eid>/categories/', views.EventAttendanceCategoryListView.as_view(),
        name='event_attendance_category_update'),
    path('events/<int:eid>/attendance/<int:pk>/edit', views.EventAttendanceCategoryUpdateView.as_view(),
        name='event_attendance_category_update'),
